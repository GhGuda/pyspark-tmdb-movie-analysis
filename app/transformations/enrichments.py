...
class Tranformation:
    """
    A class to encapsulate various transformation functions
    for enriching TMDB movie data.
    """
    def __init__(self, movies_df: DataFrame):
        self.movies_df = movies_df
        
    def drop_irrelevant_columns(self) -> DataFrame:
        """
    ...
    def extracting_name_from_columns(self) -> DataFrame:
        """
    ...
    def convert_column_datatypes(self) -> DataFrame:
        """
    ...
    def replacing_unrealistic_values(self) -> DataFrame:
        """
    ...
    def clean_movies(self) -> DataFrame:
        """
    ...
    def extract_cast_and_crew(self) -> DataFrame:
        """
